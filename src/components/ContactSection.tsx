...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-6 px-4 bg-white text-elegance-navy">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto mb-6">
          <motion.div 
            className="text-center p-3 md:p-4 rounded-2xl bg-elegance-navy/10 backdrop-blur border border-elegance-navy/20"
            whileHover={{ y: -5 }}
